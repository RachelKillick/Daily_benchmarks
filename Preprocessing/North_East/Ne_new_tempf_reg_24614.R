...
tempfall8114 <- get.var.ncdf(nealltempf8114) 	         # SLP for each day from 1st January 1970 to 31st December 2011 - a matrix with 6 columns and 9 rows 
...
tempfinterpp8114a=data.frame(matrix(ncol=2,nrow=19328400))
...
call8114a=interpp(lat8114a,lon8114a,TEMPF8114a,neele$Lat,neele$Long, linear=TRUE, extrap=FALSE, duplicate = "error")

j=1260*(i-1)+1
j1=1260*i
tempfinterpp8114a[j:j1,1]=call8114a$z
tempfinterpp8114a[j:j1,2]=neele$Code
...
save(tempfinterpp8114c,file='tempf_ne24614.RData')

rm(tempfinterpp8114a,tempfinterpp8114b,tempfinterpp8114c,call8114a,i,j,j1,lat8114a,lon8114a,nealltempf8114,neele,NEregcoast1,tempf8114,TEMPF8114a,tempfall8114,x8114,y8114,yneg8114)
