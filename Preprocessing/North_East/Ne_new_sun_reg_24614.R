...
sunall8114 <- get.var.ncdf(neallsun8114) 	         # SLP for each day from 1st January 1970 to 31st December 2011 - a matrix with 6 columns and 9 rows 
...
suninterpp8114a=data.frame(matrix(ncol=2,nrow=19328400))
...
call8114a=interpp(lat8114a,lon8114a,SUN8114a,neele$Lat,neele$Long, linear=TRUE, extrap=FALSE, duplicate = "error")

j=1260*(i-1)+1
j1=1260*i
suninterpp8114a[j:j1,1]=call8114a$z
suninterpp8114a[j:j1,2]=neele$Code
...
save(suninterpp8114c,file='sun_ne24614.RData')

rm(suninterpp8114a,suninterpp8114b,suninterpp8114c,call8114a,i,j,j1,lat8114a,lon8114a,neallsun8114,neele,NEregcoast1,sun8114,SUN8114a,sunall8114,x8114,y8114,yneg8114)
