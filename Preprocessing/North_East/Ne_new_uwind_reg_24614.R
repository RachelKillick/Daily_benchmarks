...
uwall8114 <- get.var.ncdf(nealluw8114) 	         # SLP for each day from 1st January 1970 to 31st December 2011 - a matrix with 6 columns and 9 rows 
...
uwinterpp8114a=data.frame(matrix(ncol=2,nrow=19328400))
...
call8114a=interpp(lat8114a,lon8114a,UW8114a,neele$Lat,neele$Long, linear=TRUE, extrap=FALSE, duplicate = "error")

j=1260*(i-1)+1
j1=1260*i
uwinterpp8114a[j:j1,1]=call8114a$z
uwinterpp8114a[j:j1,2]=neele$Code
...
save(uwinterpp8114c,file='uwind_ne24614.RData')

rm(uwinterpp8114a,uwinterpp8114b,uwinterpp8114c,call8114a,i,j,j1,lat8114a,lon8114a,nealluw8114,neele,NEregcoast1,uw8114,UW8114a,uwall8114,x8114,y8114,yneg8114)
