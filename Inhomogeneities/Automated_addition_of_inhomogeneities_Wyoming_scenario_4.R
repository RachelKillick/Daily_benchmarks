...
load('newup_wy_comp_121114_relocations_full_smaller_temporal_weighted_averaging_different.RData')
...
load('Wyoming_smaller_inhomogeneities_231014_propogate_backwards.RData')
