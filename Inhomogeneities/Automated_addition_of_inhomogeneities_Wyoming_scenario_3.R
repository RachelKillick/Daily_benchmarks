...
Predictset$noise=Predictset$pred5th1-Predictset$lsmodel25b
...
Inhomogeneity=as.data.frame(matrix(nrow=1590,ncol=5))
...
Predictsetf$Difference=Predictsetf$Inhomogeneous-Predictsetf$lsmodel25b
...
TMEAN=as.data.frame(matrix(nrow=2423720,1))
TMEAN[1:1150500,1]=wyupdatefeb29gam$TMEAN

sstat=sort(sample(1:148,size=83,replace=FALSE))

for (i in 1:83){
	TMEAN[((i+74)*15340+1):((i+75)*15340),1]=neupdatefeb29gam$TMEAN[neupdatefeb29gam$Station==sstat[i]]
}

save(sstat,TMEAN,file='Missing_data_in_world3_231014.RData')
...
Predictsetf1$Difference=Predictsetf1$Inhomogeneous-Predictsetf1$lsmodel25b

save(Inhomogeneity,Predictsetf,Predictsetf1,file="Wyoming_denser_inhomogeneities_231014_propogate_backwards_step.RData") 
...
save(Inhomogeneitysub1,file='Inhomogeneitysub1_wyoming_denser_231014_step.RData') 
