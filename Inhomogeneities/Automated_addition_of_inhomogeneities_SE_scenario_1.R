...
load('newup_se_comp_201014_relocations_full_smaller_loess_wo59108.RData' ) # The station data - complete with relocation options - could make this smaller by getting rid of some extraneous variables - but should be OK as is I think 
